...
export class V2homeComponent {
  heroImage = 'assets/v2/heroo-800.webp';
  ...
  projects: Project[] = [
    ...
    },
    {
      ...
      Contribution:
        'Front-End Development | Responsive Design | Contact Form Integration',
    },
    {
      tag: 'Web Application',
      ...
      Contribution:
        ' User Authentication | Attendance Module | Payroll Integration | Database Design',
    },
    {
      ...
      Contribution:
        'Dynamic UI | API Integration | Address-based Service Display',
    },
    {
      tag: 'Design',
